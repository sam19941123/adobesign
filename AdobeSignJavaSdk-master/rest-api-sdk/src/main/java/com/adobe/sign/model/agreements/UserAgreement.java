...
//public FileWriter fw = new FileWriter("zzzzzzzzzz.txt");
...
public enum StatusEnum {
  ...
  /*public List<DisplayUserSetInfo> getDisplayUserSetInfos() {
    System.out.println("user:"+displayUserSetInfos);
    return displayUserSetInfos;
  }*/

  public List<DisplayUserInfo> getDisplayUserSetInfos() {
    System.out.println("user:"+displayUserSetInfos);
    return displayUserSetInfos.get(0).displayUserSetMemberInfos;
    //return ((displayUserSetInfos.get(0)).displayUserSetMemberInfos.get(0)).email;
    //return displayUserSetInfos;
  }
  /**
   * The most relevant current user set for the agreement. It is typically the next signer if the agreement is from the current user, or the sender if received from another user
  ...
  public String getLatestVersionId() {
    System.out.println("version:"+latestVersionId);

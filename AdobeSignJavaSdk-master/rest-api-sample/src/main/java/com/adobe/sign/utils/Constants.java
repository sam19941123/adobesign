...
public class Constants {
  ...
  private static final String ACCESS_TOKEN_KEY= "3AAABLblqZhCFzWVPczuAHtJglPx22WNkCXRzQPAhim-O8J2nrUTKKzuJdoPfHLkjSke_rmfxD11nH3omXBYKVk7DYY8TwFz4";
  ...
  public static final int AGREEMENT_COUNT_LIMIT = 1000;//Integer.parseInt(properties.getProperty(AGREEMENT_COUNT_LIMIT_KEY).equals("null") ? MINUS_ONE : properties.getProperty(AGREEMENT_COUNT_LIMIT_KEY));
  ...
  public static final String USER_EMAIL_PREFIX = "sam_huang";//properties.getProperty(USER_EMAIL_PREFIX_KEY).equals("null") ? null : properties.getProperty(USER_EMAIL_PREFIX_KEY);
  public static final String USER_EMAIL_DOMAIN = "i-planet.com.tw";//properties.getProperty(USER_EMAIL_DOMAIN_KEY).equals("null") ? null : properties.getProperty(USER_EMAIL_DOMAIN_KEY);
